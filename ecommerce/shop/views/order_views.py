...
#                     {
#                         "errors": {
#                             "error": f"{item.size} size and {item.color} color combination is not available for {item.product.name}.",
#                             "status_code": status.HTTP_200_OK,
#                         }
#                     },
#                     status=status.HTTP_200_OK,
...
#                     {
#                         "errors": {
#                             "error": f"Not enough stock for {item.product.name}. Only {inventory.quantity} units available.",
#                             "status_code": status.HTTP_200_OK,
#                         }
#                     },
#                     status=status.HTTP_200_OK,
